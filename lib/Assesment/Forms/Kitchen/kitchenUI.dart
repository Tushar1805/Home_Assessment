...
class KitchenUI extends StatefulWidget {
  ...
  KitchenUI(this.roomname, this.wholelist, this.accessname, this.docID);
  @override
...
class _KitchenUIState extends State<KitchenUI> {
  ...
  fillDropItem() {
    ...
    setState(() {
      for (var i = 0; i < widget.wholelist[3]['count']; i++) {
        if (widget.wholelist[3]['room${i + 1}']['isUsed'][0]) {
      ...
      itemList.forEach((element) {
        DropdownMenuItem<String> ddmi = DropdownMenuItem<String>(
          child: Text("${widget.wholelist[3][element.toString()]['name']}",
  ...
  Widget toggleButton(BuildContext context, KitchenPro assesmentprovider,
    ...
    return Container(
      ...
      child: ToggleButtons(
          ...
          if (assessor == therapist && role == "therapist") {
            setState(() {
              for (int i = 0;
                  i <
                      widget
                          .wholelist[3][widget.accessname]['question']
                              ['$queIndex']['toggle']
                          .length;
                  i++) {
        ...
        isSelected: widget.wholelist[3][widget.accessname]['question']
                ['$queIndex']['toggle']
            .cast<bool>(),
      ),
    );
                    ...
                    child: DropdownButton(
                      ...
                      onChanged: (value) {
                        setState(() {
                          ...
                          widget.roomname =
                              widget.wholelist[3][widget.accessname]['name'];
                        });
                        ...
                        Navigator.of(context)
                            .pushReplacement(MaterialPageRoute(
                                builder: (context) => Kitchen(
                                    ...
                                    widget.docID)))
                            .then((value) => setState(() {
                                  widget.wholelist[3][widget]['complete'] =
                                      value['complete'];
  ...
  void listenDropButton(KitchenPro assesmentprovider) {
    var test = widget.wholelist[3][widget.accessname]['complete'];
    for (int i = 0;
        i < widget.wholelist[3][widget.accessname]['question'].length;
        i++) {
