...
//     for (var k = 1; k <= widget.wholelist[0]['count']; k++) {
//       var _textfield$k = TextEditingController();
//       _textfield$k.text =
//           widget.wholelist[0]['room$k']['question']["1"]['Recommendation'];
//       for (int i = 0;
//           i < widget.wholelist[0]['room$k']['question'].length;
//           i++) {
//         _controllers["${k}field${i + 1}"] = TextEditingController();
//         _controllerstreco["${k}field${i + 1}"] = TextEditingController(
//             text: getprio(6, k) == '1'
...
//                 : 'Recommendation');
//         isListening["${k}field${i + 1}"] = false;
//         _controllers["${k}field${i + 1}"].text = widget.wholelist[0]['room$k']
//             ['question']["${i + 1}"]['Recommendation'];
//         _controllerstreco["${k}field${i + 1}"].text =
//             '${widget.wholelist[0]['room$k']['question']["${i + 1}"]['Recommendationthera']}';
//         colorsset["${k}field${i + 1}"] = Color.fromRGBO(10, 80, 106, 1);
//       }
//     }
//     // setinitials();
//     getRole();
//     for (var i = 1; i <= widget.wholelist[0]['count']; i++) {
//       getAssessData(i);
//     }
...
//   Future<void> getAssessData(index) async {
...
//               videoUrl = widget.wholelist[0]['room$index']["videos"]["url"]
//                       .toString() ??
//                   "";
//               videoName = widget.wholelist[0]['room$index']["videos"]["name"]
//                       .toString() ??
//                   "";
//             }));
//   }
...
//     widget.wholelist[0]['room$accessname']['question']["$index"]['Question'] =
//         que;
//     if (value.length == 0) {
//       if (widget.wholelist[0]['room$accessname']['question']["$index"]['Answer']
//               .length ==
//           0) {
//       } else {
//         setState(() {
//           widget.wholelist[0]['room$accessname']['complete'] -= 1;
//           widget.wholelist[0]['room$accessname']['question']["$index"]
//               ['Answer'] = value;
//           widget.wholelist[0]['room$accessname']['question']["$index"]
//               ['Question'] = que;
//         });
...
//       }
//       setState(() {
//         widget.wholelist[0]['room$accessname']['question']["$index"]['Answer'] =
//             value;
//       });
//     }
//   }
...
//   getvalue(index, accessname) {
//     return widget.wholelist[0]['room$accessname']['question']["$index"]
//         ['Answer'];
//   }

//   /// This function helps us to get recommendation value form the map
//   getreco(index, accessname) {
//     return widget.wholelist[0]['room$accessname']['question']["$index"]
//         ['Recommendation'];
//   }

// // This fucntion helps us to set the priority of the fields.
//   setprio(index, value, accessname) {
//     setState(() {
//       widget.wholelist[0]['room$accessname']['question']["$index"]['Priority'] =
//           value;
//     });
//   }

// // This fucntion helps us to get the priority of the fields.
//   getprio(index, accessname) {
//     return widget.wholelist[0]['room$accessname']['question']["$index"]
//         ['Priority'];
//   }
...
//   Widget toggleButton(BuildContext context, PathwayPro pathwaypro, int queIndex,
//       String que, int accessname) {
//     return Container(
//       height: 35,
//       child: ToggleButtons(
...
//                   i <
//                       widget
//                           .wholelist[0]['room$accessname']['question']
//                               ['$queIndex']['toggle']
//                           .length;
//                   i++) {
//                 widget.wholelist[0]['room$accessname']['question']['$queIndex']
//                     ['toggle'][i] = i == select;
//               }
//             });
//             pathwaypro.setdata(
...
//           }
//         },
//         isSelected: widget.wholelist[0]['room$accessname']['question']
//                 ['$queIndex']['toggle']
//             .cast<bool>(),
//       ),
//     );
...
//     Future<void> upload(File videos, int accessname) async {
//       setState(() {
//         uploading = true;
//       });
//       try {
...
//           widget.wholelist[0]['room${accessname + 1}']["videos"]["url"] =
//               videoUrl;
//           widget.wholelist[0]['room${accessname + 1}']["videos"]["name"] =
//               videoName;
...
//     Future<void> selectVideo(String source, int accessname) async {
//       if (video == null) {
//         if (source == 'camera') {
//           final pickedVideo =
...
//             setState(() {
//               upload(File(pickedVideo?.path), accessname);
//             });
//           } else {
//             Navigator.pop(context);
//             setState(() {});
...
//     void uploadVideo(BuildContext context, int accessname) {
//       showDialog(
//           context: context,
//           builder: (context) {
//             return AlertDialog(
...
//                             child: InkWell(
//                               onTap: () async {
//                                 await selectVideo('camera', accessname);
//                               },
//                               child: Padding(
...
//                             child: InkWell(
//                               onTap: () async {
//                                 await selectVideo('gallery', accessname);
//                               },
//                               child: Padding(
//                                 padding: const EdgeInsets.all(8.0),
//                                 child: Column(
...
//       setState(() {
//         widget.wholelist[0]['room$accessname']['question']["$index"]
//             ['Recommendation'] = _controllers["${accessname}field$index"].text;
//         cur = !cur;
//       });
//     }

//     /// this fucntion helps us to listent to hte done button at the bottom
//     void listenDropButton(BuildContext context, int index) {
//       var test = widget.wholelist[0]['room$index']["complete"];
//       for (int i = 0;
//           i < widget.wholelist[0]['room$index']['question'].length;
//           i++) {
...
//         NewAssesmentRepository().setForm(widget.wholelist, widget.docID);
//         // Navigator.pop(context, widget.wholelist[0]['room$index']);
//         // } else {
...
//       }
//       _onExpansionChanged(false);
//       // }
//     }

//     void listenbutton(BuildContext context, int index) {
//       var test = widget.wholelist[0]['room$index']["complete"];
//       for (int i = 0;
//           i < widget.wholelist[0]['room$index']['question'].length;
//           i++) {
...
//     void _listen(index, bool isthera, accessname) async {
//       if (!isListening['${accessname}field$index']) {
//         bool available = await _speech.initialize(
//           onStatus: (val) {
//             print('onStatus: $val');
//             if (val == 'notListening') {
//               setState(() {
//                 isListening['${accessname}field$index'] = false;
//               });
//             }
//           },
...
//           setState(() {
//             // _isListening = true;
//             colorsset["${accessname}field$index"] =
//                 Color.fromRGBO(10, 80, 106, 1);
//             isListening['${accessname}field$index'] = true;
//           });
//           if (isthera) {
//             _speech.listen(
//                 onResult: (val) => setState(() {
//                       _controllerstreco["${accessname}field$index"].text =
//                           widget.wholelist[0]['room$accessname']['question']
...
//             _speech.listen(
//                 onResult: (val) => setState(() {
//                       _controllers["${accessname}field$index"].text =
//                           widget.wholelist[0]['room$accessname']['question']
...
//     ticklisten(index, int accessname) {
//       print('clicked');
//       setState(() {
//         // _isListening = false;
//         isListening['${accessname}field$index'] = false;
//         colorsset["${accessname}field$index"] = Color.fromRGBO(10, 80, 106, 1);
//       });
//       _speech.stop();
//     }

//     setdatalistenThera(index, accessname) {
//       setState(() {
//         widget.wholelist[0]['room$accessname']['question']["$index"]
//                 ['Recommendationthera'] =
//             _controllerstreco["${accessname}field$index"].text;
...
//     Widget getrecowid(index, BuildContext context, accessname) {
//       // if (index == 6) {
//       //   getprio(index) == '1'
...
//       //           ['Recommendationthera'] = '';
//       // }
//       if (widget.wholelist[0]['room$accessname']["question"]["$index"]
//               ["Recommendationthera"] !=
//           "") {
//         setState(() {
//           isColor = true;
...
//             saveToForm = true;
//             trueIndex = index;
//             widget.wholelist[0]['room$accessname']["isSave"] = saveToForm;
//           });
//         } else {
//           setState(() {
//             saveToForm = false;
...
//               "") {
//             setState(() {
//               widget.wholelist[0]['room$accessname']["isSave"] = true;
//               falseIndex = -1;
//             });
//           } else {
//             setState(() {
//               widget.wholelist[0]['room$accessname']["isSave"] = false;
//             });
//           }
//         }
//       }
...
//               setrecothera(index, value, accessname);
//             },
//             controller: _controllerstreco["${accessname}field$index"],
...
//                     child: AvatarGlow(
//                       animate: isListening['${accessname}field$index'],
...
//                       if (index == 6) {
//                         setState(() {
//                           _controllerstreco['${accessname}field6'].text =
//                               'Please install a well functioning Smoke detector Immediately. Most states have free Smoke Detectors available for FREE. Please contact your local Fire Department';
//                           setrecothera(
//                               6,
//                               'Please install a well functioning Smoke detector Immediately. Most states have free Smoke Detectors available for FREE. Please contact your local Fire Department',
...
//                       }
//                     },
//                     groupValue: getprio(index, accessname),
//                   ),
//                   Text('1'),
//                   Radio(
//                     value: '2',
...
//     /// priority field.
//     Widget getrecomain(
//         int index, bool isthera, BuildContext context, int accessname) {
...
//                         maxLines: 1,
//                         showCursor: cur,
//                         controller: _controllers["${accessname}field$index"],
//                         decoration: InputDecoration(
...
//                           onPressed: () {
//                             if (assessor == therapist && role == "therapist") {
//                               _listen(index, false, accessname);
//                               setdatalisten(index, accessname);
//                               Timer(Duration(seconds: 3), () {
//                                 ticklisten(index, accessname);
//                               });
//                             } else if (role != "therapist") {
//                               _listen(index, false, accessname);
//                               setdatalisten(index, accessname);
...
//                   border: Border.all(
//                     color: colorsset["${accessname}field$index"],
//                     width: 1,
//                   ), //Border.all
...
//                   ? getrecowid(index, context, accessname)
//                   : SizedBox(),
//             ],
//           ),
//         ),
...
//     Widget stepcountswid(index, BuildContext context, accessname) {
//       return Container(
//         child: Column(
//           children: [
//             Container(
...
//       onWillPop: () async {
//         bool save = false;
//         int count = widget.wholelist[0]['count'] ?? 0;
//         print("count = $count");
//         if (count > 0) {
...
//             print("********2nd loop*****");
//             if (widget.wholelist[0]['name'] == 'Living Arrangements') {
//               if (widget.wholelist[0]["room$j"]["complete"] == 12) {
//                 // setState(() {
//                 //   save = true;
//                 // });
//                 if (role == "therapist") {
//                   if (widget.wholelist[0]["room$j"]["isSave"] != null &&
//                       widget.wholelist[0]["room$j"]["isSave"] == true) {
//                     setState(() {
//                       save = true;
//                     });
//                   } else {
...
//               }
//             } else {
//               if (widget.wholelist[0]["room$j"]["isUsed"][0]) {
//                 if (widget.wholelist[0]["room$j"]["complete"] == 12) {
//                   // setState(() {
//                   //   save = true;
//                   // });
...
//                 content: new Text("Details Saved."),
//                 actions: <Widget>[
...
//                 title: new Text("Form Incomplete"),
//                 content: new Text(
//                     "Oops, Form is incomplete. Please fill out and then continue. Make sure you pressed submit before leaving this page.\n\nStill want to leave the page?"),
//                 actions: <Widget>[
//                   // usually buttons at the bottom of the dialog
//                   Row(
//                     mainAxisAlignment: MainAxisAlignment.spaceBetween,
...
//             // color: newBBSList.length > 0
//             //     ? Color(0xfff2f2f2)
//             //     : Colors.white,
//             child: Padding(
//           padding: const EdgeInsets.fromLTRB(5, 0, 5, 0),
//           child: widget.wholelist.length > 0
//               ? ListView.builder(
//                   physics: BouncingScrollPhysics(),
//                   scrollDirection: Axis.vertical,
//                   shrinkWrap: true,
//                   itemCount: widget.wholelist[0]['count'],
//                   itemBuilder: (context, index) {
//                     return Card(
//                       elevation: 2,
//                       borderOnForeground: true,
//                       shadowColor: Color.fromRGBO(10, 80, 106, 1),
//                       child: ExpansionTile(
//                         collapsedTextColor: Color.fromRGBO(10, 80, 106, 1),
...
//                                     ),
//                                     Text(
//                                       widget.wholelist[0]['room${index + 1}']
//                                           ['name'],
//                                       style: TextStyle(
//                                           fontSize: 18,
...
//                                     ),
//                                     /*
//                                                            # Should be Commented to remove RangeError
//                                                            */
//                                   ],
//                                 ),
//                               ),
...
//                                             ),
//                                             SizedBox(height: 15),
//                                             (getvalue(1, index + 1) == 'Yes')
//                                                 ? getrecomain(
//                                                     1, true, context, index + 1)
//                                                 : SizedBox(),
//                                             SizedBox(height: 15),
//                                             Row(
//                                               mainAxisAlignment:
...
//                                             ),
//                                             SizedBox(height: 15),
//                                             (getvalue(4, index + 1) == 'No')
//                                                 ? getrecomain(
//                                                     4, true, context, index + 1)
//                                                 : SizedBox(),
//                                             SizedBox(
//                                               height: 15,
//                                             ),
...
//                                             ),
//                                             SizedBox(height: 15),
//                                             (getvalue(6, index + 1) == 'No')
//                                                 ? getrecomain(
//                                                     6, true, context, index + 1)
//                                                 : SizedBox(),
...
//                                                                           .3,
//                                                                       child: TextFormField(
//                                                                           initialValue: widget.wholelist[0]['room${index + 1}']['question']["7"]['stepCount']["count"].toString(),
//                                                                           decoration: InputDecoration(
//                                                                               focusedBorder: OutlineInputBorder(
//                                                                                 borderSide: BorderSide(color: Color.fromRGBO(10, 80, 106, 1), width: 1),
//                                                                               ),
//                                                                               enabledBorder: OutlineInputBorder(
...
//                                                                                 role == "therapist") {
//                                                                               setState(() {
//                                                                                 widget.wholelist[0]['room${index + 1}']['question']["7"]['stepCount']["count"] = value;
//                                                                               });
//                                                                             } else if (role !=
//                                                                                 "therapist") {
//                                                                               setState(() {
...
//                                                                 ),
//                                                               ),
//                                                               widget.wholelist[0]['room${index + 1}']['question']["7"]['stepCount']["count"] !=
//                                                                           '0' &&
//                                                                       widget.wholelist[0]['room${index + 1}']['question']["7"]['stepCount']
//                                                                               [
//                                                                               "count"] !=
//                                                                           ""
//                                                                   ? Container(
...
//                                                                                   ),
//                                                                                   enabledBorder: OutlineInputBorder(
//                                                                                     borderSide: BorderSide(width: 1, color: colorsset["field${7}"]),
//                                                                                   ),
//                                                                                   labelText: 'Step Width:'),
//                                                                               onChanged: (value) {
//                                                                                 if (assessor == therapist && role == "therapist") {
//                                                                                   setState(() {
//                                                                                     widget.wholelist[0]['room${index + 1}']['question']["7"]['Single Step Width'] = value;
//                                                                                   });
//                                                                                 } else if (role != "therapist") {
//                                                                                   setState(() {
//                                                                                     widget.wholelist[0]['room${index + 1}']['question']["7"]['Single Step Width'] = value;
...
//                                                                                 if (assessor == therapist && role == "therapist") {
//                                                                                   setState(() {
//                                                                                     widget.wholelist[0]['room${index + 1}']['question']["7"]['Single Step Height'] = value;
//                                                                                   });
//                                                                                 } else if (role != "therapist") {
//                                                                                   setState(() {
//                                                                                     widget.wholelist[0]['room${index + 1}']['question']["7"]['Single Step Height'] = value;
...
//                                                                               role == "therapist") {
//                                                                             setState(() {
//                                                                               widget.wholelist[0]['room${index + 1}']['question']["7"]['MultipleStair']['count'] = value;
//                                                                               widget.wholelist[0]['room${index + 1}']['question']["7"]['Recommendation'] = value;

//                                                                               stepcount = widget.wholelist[0]['room${index + 1}']['question']["7"]['Recommendation'];
//                                                                               if (value > 0) {
//                                                                                 widget.wholelist[0]['room${index + 1}']['question']["7"]['MultipleStair']['step$value'] = {
//                                                                                   'stepwidth': '',
//                                                                                   'stepheight': ''
//                                                                                 };

//                                                                                 if (widget.wholelist[0]['room${index + 1}']['question']["7"]['MultipleStair'].containsKey('step${value + 1}')) {
//                                                                                   widget.wholelist[0]['room${index + 1}']['question']["7"]['MultipleStair'].remove('step${value + 1}');
//                                                                                 }
//                                                                               } else if (value == 0) {
//                                                                                 if (widget.wholelist[0]['room${index + 1}']['question']["7"]['MultipleStair'].containsKey('step${value + 1}')) {
//                                                                                   widget.wholelist[0]['room${index + 1}']['question']["7"]['MultipleStair'].remove('step${value + 1}');
...
//                                                                             });
//                                                                           } else {
//                                                                             _showSnackBar("You can't change the other fields",
//                                                                                 context);
//                                                                           }
...
//                                                                             itemBuilder:
//                                                                                 (context, index1) {
//                                                                               return stepcountswid(index1 + 1, context, index + 1);
//                                                                             },
//                                                                           ),
//                                                                         ),
//                                                                       ),
...
//                                                                         role ==
//                                                                             "therapist") {
//                                                                       widget.wholelist[0]['room${index + 1}']['question']["8"]['Railling']['OneSided']
//                                                                               [
//                                                                               'GoingUp'] =
//                                                                           value;
//                                                                     } else if (role !=
...
//                                                                     }
//                                                                   },
//                                                                   value: widget.wholelist[0]['room${index + 1}']['question']["8"]
//                                                                               [
//                                                                               'Railling']
//                                                                           [
//                                                                           'OneSided']
...
//                                         ),
//                                         onPressed: () async {
//                                           listenDropButton(context, index + 1);
...
class _PathwayUIState extends State<PathwayUI> {
  ...
  void initState() {
    ...
    for (int i = 0;
      ...
      _controllerstreco["field${i + 1}"].text =
          '${capitalize(widget.wholelist[0][widget.accessname]['question']["${i + 1}"]['Recommendationthera'])}';
  ...
  fillDropItem() {
    ...
    setState(() {
      for (var i = 0; i < widget.wholelist[0]['count']; i++) {
        if (widget.wholelist[0]['room${i + 1}']['isUsed'][0]) {
      ...
      itemList.forEach((element) {
        DropdownMenuItem<String> ddmi = DropdownMenuItem<String>(
          child: Text("${widget.wholelist[0][element.toString()]['name']}",
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        ...
        //       // return object of type Dialog
        //       return AlertDialog(
        //         title: new Text("Not Saved"),
        //         content: new Text(
        //             "Please click the submit button before leaving the page."),
        //         actions: <Widget>[
        //           // usually buttons at the bottom of the dialog
        //           new FlatButton(
        //             child: new Text(
                    ...
                    child: DropdownButton(
                      ...
                      onChanged: (value) {
                        setState(() {
                          ...
                          widget.roomname =
                              widget.wholelist[0][widget.accessname]['name'];
                        });
                        ...
                        Navigator.of(context)
                            .pushReplacement(MaterialPageRoute(
                                builder: (context) => Pathway(
                                    ...
                                    widget.docID)))
                            .then((value) => setState(() {
                                  widget.wholelist[0][widget]['complete'] =
                                      value['complete'];
