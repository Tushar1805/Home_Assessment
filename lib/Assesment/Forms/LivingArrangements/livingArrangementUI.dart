                  ...
                  children: [
                        ...
                        Container(
                          child: DropdownButton(
                            ...
                            onChanged: (value) {
                              ...
                              if (assessor == therapist &&
                                  role == "therapist") {
                                assesspro.setdata(2, value, 'Number of Levels');
                              } else if (role != "therapist") {
                                assesspro.setdata(2, value, 'Number of Levels');
                              } else {
                                _showSnackBar(
                        ...
                        Container(
                          child: DropdownButton(
                            ...
                            onChanged: (value) {
                              ...
                              if (assessor == therapist &&
                                  role == "therapist") {
                                assesspro.setdata(3, value, 'Living on Level');
                              } else if (role != "therapist") {
                                assesspro.setdata(3, value, 'Living on Level');
                              } else {
                                _showSnackBar(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: ToggleButtons(
                            ...
                            isSelected: widget.wholelist[1][widget.accessname]
                                    ['question']['5']['toggle']
                                .cast<bool>(),
                          ),
                        ),
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          width: MediaQuery.of(context).size.width * .4,
                          child: Text('Able to get in & out of doors & steps?',
                              style: TextStyle(
                                color: Color.fromRGBO(10, 80, 106, 1),
                                fontSize: 20,
                              )),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                DropdownButton(
                                  ...
                                  value: widget.wholelist[1][widget.accessname]
                                          ['question']["7"]['additional']
                                      ["assistiveDevice"],
                                )
                              ],
