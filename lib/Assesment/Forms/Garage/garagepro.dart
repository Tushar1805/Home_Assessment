...
class GaragePro extends ChangeNotifier {
  ...
  Future<void> setinitials() async {
    ...
    if (wholelist[9][accessname]['question'][15].containsKey('ManageInOut')) {
    } else {
      wholelist[9][accessname]['question'][15]['ManageInOut'] = '';
    }
    ...
    if (wholelist[9][accessname]['question'][17].containsKey('sidefentrance')) {
    } else {
  ...
  setdata(index, value) {
    if (value.length == 0) {
      if (wholelist[9][accessname]['question'][index]['Answer'].length == 0) {
      } else {
  ...
  setrecothera(index, value) {
    wholelist[9][accessname]['question'][index]['Recommendationthera'] = value;
    notifyListeners();
  }
  ...
  getrecothera(index) {
    return wholelist[9][accessname]['question'][index]['Recommendationthera'];
  }
