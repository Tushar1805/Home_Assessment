...
class _BedroomUIState extends State<BedroomUI> {
  ...
  fillDropItem() {
    ...
    setState(() {
      for (var i = 0; i < widget.wholelist[6]['count']; i++) {
        if (widget.wholelist[6]['room${i + 1}']['isUsed'][0]) {
      ...
      itemList.forEach((element) {
        DropdownMenuItem<String> ddmi = DropdownMenuItem<String>(
          child: Text("${widget.wholelist[6][element.toString()]['name']}",
                    ...
                    child: DropdownButton(
                      ...
                      onChanged: (value) {
                        setState(() {
                          ...
                          widget.roomname =
                              widget.wholelist[6][widget.accessname]['name'];
                        });
                        ...
                        Navigator.of(context)
                            .pushReplacement(MaterialPageRoute(
                                builder: (context) => Bedroom(
                                    ...
                                    widget.docID)))
                            .then((value) => setState(() {
                                  widget.wholelist[6][widget]['complete'] =
                                      value['complete'];
